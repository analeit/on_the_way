...
let item1 = $(".grid-item-1").height();
let item2 = $(".grid-item-2").height();
let item3 = $(".grid-item-3").height();
let item4 = $(".grid-item-4").height();
let item5 = $(".grid-item-5").height();
let item6 = $(".grid-item-6").height();
let item7 = $(".grid-item-7").height();
let item8 = $(".grid-item-8").height();
let item9 = $(".grid-item-9").height();
